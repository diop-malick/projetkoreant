          ...
          <div class="product-information">
            ...
            {block name='page_header_container'}
              {block name='page_header'}
                <h1 class="h1" itemprop="name">{block name='page_title'}{$product.name|substr:0:($product.name|strpos:" ")}<br>{$product.name|substr:($product.name|strpos:" "+1)}{/block}</h1>
              {/block}
            {/block}
    ...
    {block name='product_accessories'}
      {if $accessories}
        <section class="product-accessories clearfix">
          <h3 class="products-section-title">{l s='You might also like' d='Shop.Theme.Catalog'}</h3>
          <div class="products">
